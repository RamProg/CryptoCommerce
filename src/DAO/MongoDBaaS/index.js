...
class DAOMongoDBaaS {
    constructor() {
        this.products = (0, mongoose_1.model)("products", ProductSchema);
        this.carts = (0, mongoose_1.model)("carts", CartSchema);
        this.users = (0, mongoose_1.model)("users", UserSchema);
        this.getAll = (table) => __awaiter(this, void 0, void 0, function* () {
            try {
                yield (0, connectionMongoDB_1.connect)();
                const collection = yield eval("this." + table).find();
                yield (0, connectionMongoDB_1.close)();
                return collection;
            }
            catch (error) {
                // console.log(error);
