...
const modoCluster = ((_a = process.argv[3]) === null || _a === void 0 ? void 0 : _a.toLocaleLowerCase()) === "cluster" || false;
if (modoCluster && cluster_1.default.isPrimary) {
    ...
    app.get("/", (req, res) => {
        res.send(`Servidor express en ${PORT} - PID ${process.pid} - ${(0, moment_1.default)().format("DD/MM/YYYY HH:mm")}`);
    });
    if (config_1.default + 1 === 3)
        (0, MySQL_1.initializeMariaDB)(); // the add is to prevent a ts error
    if (config_1.default + 1 === 5)
        (0, SQLite_1.initializeSQLite)(); // the add is to prevent a ts error
    ...
    io.on("connection", (socket) => {
        ...
        socket.on("newMessage", (data) => {
            const time = (0, moment_1.default)().format("DD/MM/YYYY HH:MM:SS").toString();
            data.time = `[${time}]: `;
    ...
    app.engine("hbs", (0, express_handlebars_1.default)(hbsOptions));
    app.set("views", "./views");
    ...
    const clientID = (_b = process.argv[2]) !== null && _b !== void 0 ? _b : "583873459587516";
    const clientSecret = (_c = process.argv[3]) !== null && _c !== void 0 ? _c : "ff9792055e390e55b6097a2e0d35dcfe";
    ...
    productsRouter.get("/test-view", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        if (qty === 0)
            ...
            const response = (0, Faker_1.default)(qty);
            res.json(response);
        }
    }));
    productsRouter.get("/list/:id", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const product = yield Product_1.default.getProduct((_d = req.params) === null || _d === void 0 ? void 0 : _d.id);
    ...
    productsRouter.patch("/update/:id", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const { name, description, code, thumbnail, price, stock } = req.body;
        res.json(yield Product_1.default.update((_e = req.params) === null || _e === void 0 ? void 0 : _e.id, name, description, code, thumbnail, Number(price), Number(stock)));
    }));
    productsRouter.delete("/delete/:id", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const result = yield Product_1.default.delete((_f = req.params) === null || _f === void 0 ? void 0 : _f.id);
        console.log(result);
        if (!result)
    ...
    cartRouter.post("/add/:id_product", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
        var _g;
        const product = yield Product_1.default.getProduct((_g = req.params) === null || _g === void 0 ? void 0 : _g.id_product);
        if (product) {
    ...
    cartRouter.delete("/delete/:id", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
        var _h, _j;
        const remove = yield Cart_1.default.removeFromCart((_j = (_h = req.params) === null || _h === void 0 ? void 0 : _h.id) === null || _j === void 0 ? void 0 : _j.toString());
        if (remove)
